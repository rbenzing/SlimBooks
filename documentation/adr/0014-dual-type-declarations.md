...
| `src/utils/settingsValidation.ts` | Zod schemas (`SecurityConfigSchema`, `PasswordPolicySchema`, `StripeSchema`, etc.) that validate a settings shape before it's saved |
