...
last year, today, yesterday, this week, last week — or a custom range.

**Both ends are inclusive.** A range of 1 January to 31 January includes
everything on 31 January, not everything up to its midnight.
...
**A figure disagrees with the dashboard.** Check the accounting basis and the
date range. Cash and accrual will differ, and so will "this month" and "month
to date".
